...
@MapperScan(basePackages="com.javateam.springTransactionAnnotation.mapper")//, 
...
public class DbConfig extends WebMvcConfigurationSupport {
	...
	public DataSource getDataSourceJDBC() {
		...
		sdds.setUsername("sample");
		sdds.setPassword("sample");
	...
	public DataSource getDataSourceDBCP() {
		...
		bd.setUsername("sample");
		bd.setPassword("sample");
		bd.setMaxTotal(10);
		bd.setMaxIdle(5);
