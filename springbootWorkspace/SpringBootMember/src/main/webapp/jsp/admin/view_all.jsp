	...
	for (var delete_btn of delete_btns) {
		...
		delete_btn.onclick = function(e) {
			...
			if (confirm("정말 삭제하시겠습니까?")) {
				...
				location.href = "${rootPath}/member/member_delete.do?memberId="+memberId;
			} //
...
<body>
	...
	<div id="view_all_wrap">
		...
		<table id="view_all_table">
			...
			<tbody>
				...
				<tr>
					...
					<!-- date conversion error patch -->
					<fmt:parseDate var="memberBirth" parseLocale="en_US" 
								   value="${member.memberBirth}" 
								   pattern="EEE MMM dd HH:mm:ss z yyyy"/>
					
					<td><fmt:formatDate value="${memberBirth}" pattern="yyyy년 M월 d일" /></td>
        ...
        <table id="paging_tbl">
            ...
            <tr>
                <!-- 폼 추가 -->
                <form name="searchForm" method="get" action="${rootPath}/admin/search_proc.do">
                    ...
                    <td class="row">
                        ...
                        &nbsp;
                        <input type="submit" value="검색" class="btn btn-sm btn-primary ml-1 mr-1" /> <!-- 전송 버튼으로 변경 -->
                        &nbsp;
                        <!-- 전체 회원 목록 이동 버튼 -->
