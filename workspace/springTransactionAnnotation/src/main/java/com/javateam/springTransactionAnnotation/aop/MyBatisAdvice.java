package com.javateam.springTransactionAnnotation.aop;
...
public class MyBatisAdvice {
	...
	// @Pointcut("execution(* com.javateam.springTransactionAnnotation.dao.TransactionDAOMyBatis.*(..))")
	@Pointcut("execution(* *..TransactionDAOMyBatis.*(..))")
